#!/usr/bin/env python
"""
Test script for Hand Gesture Detection

This script allows you to test the hand gesture detection functionality
using your webcam. It will display the detected gestures and controls
in real-time.
"""
...
# Import our modified hand detector
...
def create_visualization(controls, width=400, height=400):
...
def main():
    ...
    print("\nHand Gesture Guide:")
    print("- Move hand left/right to steer the car")
    print("- Move hand up/down to control speed")
    print("- Make a fist to brake")
    print("- Extend thumb up with all fingers curled for boost")
    print("- Open palm for emergency stop")
    ...
    try:
        while True:
            ...
            visualization = create_visualization(controls)
            
            # Add gesture guide to the top of the visualization
            guide_text = "Gestures: Open Palm=Stop | Fist=Brake | Thumb Up=Boost"
            cv2.putText(
                visualization,
                guide_text,
                (20, 400),
